...
public class UserTypeRecord extends UpdatableRecordImpl<UserTypeRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = -77274919;

    /**
     * Setter for <code>game.user_type.user_type_id</code>.
     */
    ...
    /**
     * Getter for <code>game.user_type.user_type_id</code>.
     */
    ...
    /**
     * Setter for <code>game.user_type.name</code>.
     */
    ...
    /**
     * Getter for <code>game.user_type.name</code>.
     */
     ...
     */
    public UserTypeRecord(Integer userTypeId, String name) {
        super(UserType.USER_TYPE);
